...
$PAGE->set_url(new moodle_url('/blocks/up_grade_export/list_exports.php'));
...
$navigation = new guiding_navigation('list_exports');
...
$delete_link = function($export) use ($delete_str, $delete_icon) {
